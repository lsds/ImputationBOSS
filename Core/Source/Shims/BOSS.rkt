...
(define symbolToNewString
  (get-ffi-obj "bossSymbolToNewString" libCore (_fun _pointer -> _string))
  )
(define symbolNameToNewSymbol
  (get-ffi-obj "symbolNameToNewBOSSSymbol" libCore (_fun _string  -> _pointer)))
(define freeSymbol (get-ffi-obj "freeBOSSSymbol" libCore (_fun _pointer -> _void)))
...
(define longToNewExpression (get-ffi-obj "longToNewBOSSExpression" libCore (_fun _int64  -> _pointer)))
(define doubleToNewExpression
  (get-ffi-obj "doubleToNewBOSSExpression" libCore (_fun _double  -> _pointer)))
(define stringToNewExpression
  (get-ffi-obj "stringToNewBOSSExpression" libCore (_fun _string  -> _pointer)))
(define symbolNameToNewExpression
  (get-ffi-obj "bossSymbolNameToNewBOSSExpression" libCore (_fun _string  -> _pointer)))

(define newComplexExpression
  (get-ffi-obj "newComplexBOSSExpression" libCore
               (_fun _Symbol _size _pointer -> _pointer)))
(define freeExpression
  (get-ffi-obj "freeBOSSExpression" libCore
               (_fun _pointer -> _void)))
...
(define getTypeID (get-ffi-obj "getBOSSExpressionTypeID" libCore (_fun _pointer -> bossTypeID)))
(define getBoolValueFromExpression (get-ffi-obj "getBoolValueFromBOSSExpression" libCore
                                                (_fun _pointer -> _bool)))
(define getLongValueFromExpression (get-ffi-obj "getLongValueFromBOSSExpression" libCore
                                               (_fun _pointer -> _int64)))
(define getDoubleValueFromExpression (get-ffi-obj "getDoubleValueFromBOSSExpression" libCore
                                                 (_fun _pointer -> _double)))
(define getStringValueFromExpression (get-ffi-obj "getNewStringValueFromBOSSExpression" libCore
                                                  (_fun _pointer -> _string)))
(define getHeadFromExpression (get-ffi-obj "getHeadFromBOSSExpression" libCore
                                           (_fun _pointer -> _Symbol)))
(define getArgumentCountFromExpression (get-ffi-obj "getArgumentCountFromBOSSExpression" libCore
                                                    (_fun _pointer -> _size)))
(define getArgumentsFromExpression (get-ffi-obj "getArgumentsFromBOSSExpression" libCore
                                                (_fun _pointer -> _pointer)))

(define getSymbolNameFromExpression (get-ffi-obj "getNewSymbolNameFromBOSSExpression" libCore
                                                 (_fun _pointer -> _string)))
...
(define evaluate
  (get-ffi-obj "BOSSEvaluate" libCore (_fun _Expression -> _Expression)))
